...
from ..analyser.extractors import extract_classes_and_structs, extract_methods, extract_includes, extract_enums, remove_comments
...
def analyze_file(file_path: Path, current_data: dict):
    ...
    #extract_functions(content, current_data)
    extract_includes(content, current_data)
